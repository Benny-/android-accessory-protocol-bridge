...
public class DbusMessage {
	 ...
	 * error and terminate any connection, as the remote payload might not be reacheble. Remote payload exceptions on the
	 ...
	 * 
	 * <p>A special exception is the {@link NoValues} exception.</p>
	 * 
	 ...
	 * @throws NoValues If the d-bus message diddent contain any values
	 */
	public Object[] getValues() throws RemotePayloadException, RemoteDbusException, NoValues
	{
		if(errorName != null)
		{
			String errString;
